    ...
    <Card className="w-full max-w-md mx-auto bg-yellow-100 border-yellow-300">
      <CardContent className="p-4">
        ...
        <div className="flex flex-col space-y-2">
          <Button onClick={onGoHome} variant="outline" className="w-full justify-start">
            <Home className="mr-2 h-4 w-4" />
            Go to Home
          </Button>
          <Button onClick={onAddFriend} variant="outline" className="w-full justify-start">
            <UserPlus className="mr-2 h-4 w-4" />
            Add {partnerName} as Friend
          </Button>
          <Button onClick={onNewChat} variant="default" className="w-full justify-start">
